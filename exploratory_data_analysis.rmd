...
ggplot(df_overall, aes(x = Year, y = Value)) +
  geom_line(size=1, color="blue") +
  geom_point(color="red") +
  theme_minimal() +
  ggtitle("Overall Mean Sea Ice Extent Over Time") +
  xlab("Year") + ylab("Mean Sea Ice Extent (km²)") +
  annotate("text", x=1985, y=min(df_overall$Value)+5e4,
